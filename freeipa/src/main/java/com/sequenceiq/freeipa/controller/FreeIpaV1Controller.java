...
public class FreeIpaV1Controller implements FreeIpaV1Endpoint {
    ...
    @Override
    @InternalOnly
    public void upgradeCcmInternal(@ValidCrn(resource = CrnResourceDescriptor.ENVIRONMENT) @ResourceCrn @NotEmpty String environmentCrn,
            @AccountId String accountId) {
        upgradeCcmService.upgradeCcm(environmentCrn, accountId);
    }
