...
public enum ResourceEvent {
    ...
    SCALING_VALT_NODES_STARTED("scaling.valt.nodes.started"),
    ...
    CLUSTER_SCALING_UP_VALT2("cluster.scaling.up.valt2"),
    CLUSTER_SCALING_UP_CMHOSTS_STARTING("cluster.scaling.up.valt2.cmhostsstarting"),
    CLUSTER_SCALING_UP_CMHOSTS_STARTED("cluster.scaling.up.valt2.cmhostsstarted"),
    CLUSTER_SCALING_DOWN_CMHOSTS_ENTERING_MAINT("cluster.scaling.down.valt2.enteringmaint"),
    CLUSTER_SCALING_DOWN_CMHOSTS_ENTERED_MAINT("cluster.scaling.down.valt2.enteredmaint"),
    CLUSTER_SCALED_UP_VALT("cluster.scaled.up.valt"),
    ...
    CLUSTER_SCALING_DOWN_VALT("cluster.valt.scaling.down"),
    CLUSTER_SCALED_DOWN("cluster.scaled.down"),
    CLUSTER_SCALED_DOWN_VALT("cluster.scaled.down.valt"),
    ...
    CLUSTER_REMOVING_NODE_FROM_HOSTGROUP_VALT("cluster.removing.node.from.hostgroup.valt"),
    CLUSTER_REMOVING_NODE_FROM_HOSTGROUP2_VALT("cluster.removing.node.from.hostgroup2.valt"),
    CLUSTER_STOPPING_NODE_FROM_HOSTGROUP2_VALT("cluster.stopping.node.from.hostgroup2.valt"),
