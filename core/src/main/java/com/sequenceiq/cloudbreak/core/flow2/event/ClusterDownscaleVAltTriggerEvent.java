...
// ZZZ Identical to ClusterScaleValtTriggerEvent .... separate because the same event can likely not be associated with 2 flows (failed for upscale trying to re-use ClusterScaleTriggerEvent iirc)
public class ClusterDownscaleVAltTriggerEvent extends StackEvent implements HostGroupPayload {
    ...
    public ClusterDownscaleVAltTriggerEvent(String selector, Long stackId, String hostGroup, Integer adjustment, Set<Long> hostIds, boolean singlePrimaryGateway,
