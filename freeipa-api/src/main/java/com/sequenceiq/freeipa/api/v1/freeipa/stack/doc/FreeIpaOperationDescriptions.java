...
public final class FreeIpaOperationDescriptions {
    ...
    public static final String INTERNAL_UPGRADE_CCM_BY_ENVID_AND_ACCOUNTID =
            "Initiates the CCM tunnel type upgrade to the latest available version using the internal actor";
